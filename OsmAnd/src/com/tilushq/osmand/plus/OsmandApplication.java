...
import com.tilushq.osmand.plus.GPXUtilities.WptPt;
import com.tilushq.osmand.plus.activities.DayNightHelper;
import com.tilushq.osmand.plus.activities.LiveMonitoringHelper;
import com.tilushq.osmand.plus.activities.OsmandIntents;
import com.tilushq.osmand.plus.activities.SavingTrackHelper;
...
import com.tilushq.osmand.plus.api.SQLiteAPIImpl;
import com.tilushq.osmand.plus.api.SettingsAPI;
import com.tilushq.osmand.plus.render.NativeOsmandLibrary;
...
import com.tilushq.osmand.plus.voice.CommandPlayer;
import com.tilushq.osmand.plus.voice.CommandPlayerException;
import com.tilushq.osmand.plus.voice.CommandPlayerFactory;
	...
	public void onCreate() {
		...
		if (Version.getAppName(this).equals("OsmAnd~")) {
			if (android.os.Build.VERSION.SDK_INT >= 9) {
				try {
					Class.forName("com.tilushq.osmand.plus.base.EnableStrictMode").newInstance();
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
		...
		settingsAPI = new com.tilushq.osmand.plus.api.SettingsAPIImpl(this);
		externalServiceAPI = new com.tilushq.osmand.plus.api.ExternalServiceAPIImpl(this);
		internalToDoAPI = new com.tilushq.osmand.plus.api.InternalToDoAPIImpl(this);
		internalOsmAndAPI = new com.tilushq.osmand.plus.api.InternalOsmAndAPIImpl(this);
