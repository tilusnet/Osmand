...
import com.tilushq.osmand.plus.api.SQLiteAPI.SQLiteConnection;
import com.tilushq.osmand.plus.api.SQLiteAPI.SQLiteCursor;
...
public class SQLiteTileSource implements ITileSource {
	...
	public synchronized void insertImage(int x, int y, int zoom, File fileToSave) throws IOException {
		...
		com.tilushq.osmand.plus.api.SQLiteAPI.SQLiteStatement statement = db.compileStatement("INSERT INTO tiles VALUES(?, ?, ?, ?, ?)"); //$NON-NLS-1$
