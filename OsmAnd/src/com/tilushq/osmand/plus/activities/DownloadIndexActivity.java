...
import com.tilushq.osmand.plus.base.BasicProgressAsyncTask;
import com.tilushq.osmand.plus.base.SuggestExternalDirectoryDialog;
import com.tilushq.osmand.plus.download.DownloadActivityType;
import com.tilushq.osmand.plus.download.DownloadEntry;
import com.tilushq.osmand.plus.download.DownloadIndexAdapter;
import com.tilushq.osmand.plus.download.DownloadIndexesThread;
import com.tilushq.osmand.plus.download.IndexItem;
import com.tilushq.osmand.plus.download.IndexItemCategory;
			...
			if (Version.isMarketEnabled(getMyApplication())) {
				msg.setNeutralButton(R.string.install_paid, new OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(Version.marketPrefix(getMyApplication()) +  "com.tilushq.osmand.plus"));
						try {
