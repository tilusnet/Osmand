...
import com.tilushq.osmand.plus.voice.AbstractPrologCommandPlayer;
import com.tilushq.osmand.plus.voice.CommandBuilder;
...
public class TestVoiceActivity extends SherlockActivity {
	...
	private void addButtons(final LinearLayout ll, CommandPlayer p) {
		...
		addButton(ll, "Follow the road for 360m and arrive at waypoint", builder(p).goAhead(360).andArriveAtIntermediatePoint());
