...
import com.tilushq.osmand.plus.activities.OsmandBaseExpandableListAdapter;
...
public class DownloadIndexAdapter extends OsmandBaseExpandableListAdapter implements Filterable {
	...
	public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
		...
		if (v == null) {
			...
			v = inflater.inflate(com.tilushq.osmand.plus.R.layout.expandable_list_item_category, parent, false);
		}
		final View row = v;
	...
	public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
		...
		if (v == null) {
			LayoutInflater inflater = downloadActivity.getLayoutInflater();
			v = inflater.inflate(com.tilushq.osmand.plus.R.layout.download_index_list_item, parent, false);
		}
		final View row = v;
