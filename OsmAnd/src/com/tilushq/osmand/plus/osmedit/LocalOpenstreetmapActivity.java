...
import com.tilushq.osmand.plus.ProgressDialogImplementation;
import com.tilushq.osmand.plus.R;
import com.tilushq.osmand.plus.activities.MapActivity;
import com.tilushq.osmand.plus.activities.OsmandListActivity;
import com.tilushq.osmand.plus.osmedit.OsmPoint.Action;
...
public class LocalOpenstreetmapActivity extends OsmandListActivity {
	...
	protected class LocalOpenstreetmapAdapter extends ArrayAdapter<OsmPoint> {
		...
		public LocalOpenstreetmapAdapter() {
			super(LocalOpenstreetmapActivity.this, com.tilushq.osmand.plus.R.layout.local_openstreetmap_list_item);
		}
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (v == null ) {
				...
				v = inflater.inflate(com.tilushq.osmand.plus.R.layout.local_openstreetmap_list_item, parent, false);
			}
