...
public class MonitoringInfoControl {
	...
	public ImageViewControl createMonitoringWidget(final OsmandMapTileView view, final MapActivity map) {
		...
		final ImageViewControl monitoringServices = new ImageViewControl(view.getContext()) {
